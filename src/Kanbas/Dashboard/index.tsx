  ...
  return (
    <div id="wd-dashboard">
      <div className="d-flex align-items-center justify-content-between">
        ...
        {isStudent && <div>
          {showAllCourses ? (
            <button className="btn btn-success" onClick={() => setShowAllCourses(false)}>showEnrolledOnly</button>
          ) : (
            <button className="btn btn-primary" onClick={() => setShowAllCourses(true)}>showAllCourses</button>
          )}
        </div>}
      </div>
          ...
          {filteredCourses.map(course => (
            <div className="wd-dashboard-course col" style={{width: "300px"}}>
              <div className="card rounded-3 overflow-hidden">
                ...
                >
                  <img src={`/images/${course.imagine}`} width="100%" height={160}/>
