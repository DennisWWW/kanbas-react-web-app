...
export default function AssignmentEditor() {
  ...
  // Fetch assignment if it exists in Redux
  const assignment = useSelector((state: RootState) =>
    state.assignmentsReducer.assignments.find((a : Assignment) => a._id === aid && a.course === cid)
  );

  // Initialize form data with existing assignment data or empty values
  ...
  // Load data into form if editing an existing assignment
  useEffect(() => {
    if (assignment) {
